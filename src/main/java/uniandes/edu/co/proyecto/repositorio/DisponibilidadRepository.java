...
public interface DisponibilidadRepository extends JpaRepository<Disponibilidad, Integer> {
    ...
    void insertarDisponibilidad(@Param("fechaHora") String fechaHora, @Param("estadoDisponibilidad") String estadoDisponibilidad, @Param("registroMedico") int registroMedico, @Param("nitIPS") String nitIPS, @Param("codigoServicio") String codigoServicio);
    ...
    void actualizarDisponibilidad(@Param("id") int id, @Param("fechaHora") String fechaHora, @Param("estadoDisponibilidad") String estadoDisponibilidad, @Param("registroMedico") int registroMedico, @Param("nitIPS") String nitIPS, @Param("codigoServicio") String codigoServicio);
