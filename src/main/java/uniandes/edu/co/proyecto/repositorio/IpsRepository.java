...
public interface IpsRepository extends JpaRepository<Ips, String> {
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO IpsServicioDeSalud (nitIPS, codigoServicio) VALUES (:nitIPS, :codigoServicio)", nativeQuery = true)
    void asignarServicio(@Param("nitIPS") String nitIPS, @Param("codigoServicio") String codigoServicio);
}
